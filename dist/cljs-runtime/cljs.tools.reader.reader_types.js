...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_32628 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_32628(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_32630 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_32630(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32632 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_32632(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32635 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_32635(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32640 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_32640(reader);
}
});
...
var G__32745 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__32746 = s.append(c);
c = G__32745;
s = G__32746;
continue;
}

...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28544 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28544(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_28550 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_28550(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_28552 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_28552(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_28553 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_28553(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28554 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28554(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28561 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28561(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__28531,callback){
var map__28532 = p__28531;
var map__28532__$1 = cljs.core.__destructure_map(map__28532);
var input = map__28532__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28532__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28532__$1,new cljs.core.Keyword(null,"ns","ns",441598760));

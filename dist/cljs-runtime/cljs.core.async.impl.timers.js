...
var i_28638 = (0);
while(true){
if((i_28638 < arr.length)){
(arr[i_28638] = null);

var G__28645 = (i_28638 + (1));
i_28638 = G__28645;
continue;
} else {
}
...
var i_28657 = (self__.level + (1));
while(true){
if((i_28657 <= (new_level + (1)))){
(update[i_28657] = self__.header);

var G__28659 = (i_28657 + (1));
i_28657 = G__28659;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_28662 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28662[i]));
} else {
x__$2.forward.push((((i < links_28662.length))?(links_28662[i]):null));
}

if((i < links_28662.length)){
(links_28662[i] = x__$2);
} else {
links_28662.push(x__$2);
}
...
var links_28669 = (update[i_28664]).forward;
if((x__$1 === (((i_28664 < links_28669.length))?(links_28669[i_28664]):null))){
(links_28669[i_28664] = (x__$1.forward[i_28664]));

var G__28671 = (i_28664 + (1));
i_28664 = G__28671;
continue;
} else {
var G__28676 = (i_28664 + (1));
i_28664 = G__28676;
continue;
}
} else {
